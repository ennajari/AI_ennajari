!function() {
    ...
    Vue.createApp({
        ...
        data: () => ({
            ...
            skillsType: "skills",
            skillsItems: [
                { imgUrl: "/home/abdellah-ennajari/Desktop/AI_ennajari/assets/images/about-img.png", title: "HTML5" },
                { imgUrl: "assets/images/python-icon.png", title: "CSS3" },
                { imgUrl: "assets/images/python-icon.png", title: "JavaScript" },
                { imgUrl: "assets/images/python-icon.png", title: "TypeScript" },
                { imgUrl: "assets/images/python-icon.png", title: "jQuery" },
                { imgUrl: "assets/images/python-icon.png", title: "Bootstrap" },
                { imgUrl: "assets/images/python-icon.png", title: "Angular" },
                { imgUrl: "assets/images/python-icon.png", title: "React" },
                { imgUrl: "assets/images/python-icon.png", title: "Vue" },
                { imgUrl: "assets/images/python-icon.png", title: "Firebase" },
                { imgUrl: "assets/images/python-icon.png", title: "PugJS" },
                { imgUrl: "assets/images/python-icon.png", title: "SASS" }
            ],
            toolsItems: [
                { imgUrl: "assets/images/python-icon.png", title: "Ajax" },
                { imgUrl: "assets/images/python-icon.png", title: "Gulp" },
                { imgUrl: "assets/images/python-icon.png", title: "Webpack" },
                { imgUrl: "assets/images/python-icon.png", title: "Git (Github)" },
                { imgUrl: "assets/images/python-icon.png", title: "Npm" },
                { imgUrl: "assets/images/python-icon.png", title: "Command Line" },
                { imgUrl: "assets/images/python-icon.png", title: "VS Code" },
                { imgUrl: "assets/images/python-icon.png", title: "Trello" },
                { imgUrl: "assets/images/python-icon.png", title: "ClickUp" },
                { imgUrl: "assets/images/python-icon.png", title: "Slack" },
                { imgUrl: "assets/images/python-icon.png", title: "Photoshop" },
                { imgUrl: "assets/images/python-icon.png", title: "Adobe XD" }
            ],
            experienceItems: [
                {
                    date: "2023",
